...
\begin{figure}[h]
		...
		\label{fig1}
	\end{figure}\\
Now, for 4 tosses as given in the question the different amount of money and its probability = \{4,$\frac{1}{16}$\}, \{1.5,$\frac{1}{4}$\}, \{-1,$\frac{3}{8}$\}, \{-3.5,$\frac{1}{4}$\}, \{-6,$\frac{1}{16}$\}.\\
