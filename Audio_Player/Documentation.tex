...
\begin{itemize}
    ...
    \item \text{check\_end()} - Checks if song has ended.
\end{itemize}
...
The code for this \textbf{Audio Player} can be found at \textbf{https://github.com/ksananth4424/AI1110/blob/main\\/Audio\_Player/audioplayer.py}
