...
\title{
\textbf {Hardware Assignment}\\ \large \textbf{AI1110}: Probability and Random Variables\\Indian Institute of Techonology Hyderabad
}
...
\begin{enumerate}
\section{Output} 
	We obtained different digits which was continously fllikering on the seven segment display the output is shown in figure \ref{output}
	\begin{figure}[h]
		\item Output image:\\\\
